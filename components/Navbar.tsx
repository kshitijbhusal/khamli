            ...
            return (
              <>
                ...
                <Link key={href} href={href}
                  className=" hidden md:flex px-3.5 py-2 rounded-xl text-md font-medium transition-colors"
                  style={{
                ...
                <Link key={href} href={href}
                  className="md:hidden  px-1 py-1 rounded-xl text-sm font-medium transition-colors"
                  style={{
                    color: active ? "var(--text-primary)" : "var(--text-muted)",
                    background: active ? "var(--step-bg)" : "transparent",
                  }}
